 ...
 return (
  <div className="AboutPage">
   ...
   <div className="skillsContainer">
    ...
    <SkillsSection skill={"React Native"} progress={"30%"} width={"30%"} />
   ...
   <div className="skillsContainer">
    ...
    <SoftSkillSection
     softskill={"La communication est la base de relations saines."}
    />
    <SoftSkillSection
     softskill={"Le sens de l'organisation nécessaire au management."}
    />
    <SoftSkillSection
     softskill={"L'empathie permet une ambiance de bienveillance."}
    />
    <SoftSkillSection
     softskill={"La créativité et la curiosité nécessaires à mon bien-être."}
    />
    <SoftSkillSection
     softskill={
      "Le sens du collectif pour aller plus loin ensemble et offrir un partage de connaissances."
     }
    />
   </div>
